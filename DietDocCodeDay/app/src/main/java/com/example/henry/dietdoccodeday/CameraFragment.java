package com.example.henry.dietdoccodeday;
...
public class CameraFragment extends AppCompatActivity{
    private static final String CLOUD_VISION_API_KEY = "AIzaSyCNxvoWCyh4xWRRFcA_6UHWVHYlHILkCSY";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AlertDialog.Builder builder = new AlertDialog.Builder(CameraFragment.this);
                builder
    ...
    private void callCloudVision(final Bitmap bitmap) throws IOException {
        ...
        new AsyncTask<Object, Void, String>() {
            ...
            protected void onPostExecute(String result) {
                ...
                Toast.makeText(CameraFragment.this, queryNutrition(foodResult) + "", Toast.LENGTH_SHORT).show();
            }
        }.execute();
    }
    ...
    private String convertResponseToString(BatchAnnotateImagesResponse response) {
        ...
        if (labels != null) {
            for (EntityAnnotation label : labels) {
                foodResult = label.getDescription();
    ...
    public double queryNutrition(String query){
        ...
        try {
            ...
            Toast.makeText(CameraFragment.this, value + " calories", Toast.LENGTH_SHORT).show();
